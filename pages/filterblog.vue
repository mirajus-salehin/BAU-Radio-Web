<template>
  <section>
    <h2
      ...
      "
    >
      Posts tagged with <span class="text-brand-500">"{{ this.$route.query.tags }}"</span>
    </h2>
    <div
      class="
        grid grid-cols-1
        ...
        <nuxt-link :to="{ name: 'slug', params: { slug: fa.slug } }">
          <div class="card flex flex-col space-y-4">
            ...
            <div class="my-auto px-6">
              ...
              <p class="text-base font-light">{{ fa.description }}</p>
              <div
                class="
                  pt-4
                  flex flex-col
              ...
              >
                <div class="flex gap-2">
                  ...
                  <p class="font-extralight">{{ fa.read }}</p>
                </div>
                <div class="flex gap-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p class="font-extralight">Published at {{ fa.date }}</p>
                </div>
              </div>
            </div>
          </div>
